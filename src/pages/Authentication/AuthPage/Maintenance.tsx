...
import Illustration from '../../../images/cards/illustration-04-b7eebbfc.svg';
                        ...
                        <div className="px-4 py-20 xl:px-0">
                                    ...
                                    <div>
                                        <div className="mb-3 flex items-center gap-2">
                                            <div className="timer-box relative overflow-hidden rounded-lg">
                                                <span className="flex h-17.5 min-w-[56px] items-center justify-center rounded-lg bg-black px-3 text-xl font-black leading-[1.35] text-white dark:bg-boxdark lg:text-3xl xl:text-[40px]">2</span>
                                                <span className="absolute bottom-0 left-0 -z-1 block w-full bg-[#000]/20" style={{ height: '98.77%' }}></span>
                                            </div>
                                            <div className="timer-box relative overflow-hidden rounded-lg">
                                                <span className="flex h-17.5 min-w-[56px] items-center justify-center rounded-lg bg-black px-3 text-xl font-black leading-[1.35] text-white dark:bg-boxdark lg:text-3xl xl:text-[40px]">3</span>
                                                <span className="absolute bottom-0 left-0 -z-1 block w-full bg-[#000]/20" style={{ height: '98.77%' }}></span>
                                            </div>
                                            <div className="timer-box relative overflow-hidden rounded-lg">
                                                <span className="flex h-17.5 min-w-[56px] items-center justify-center rounded-lg bg-black px-3 text-xl font-black leading-[1.35] text-white dark:bg-boxdark lg:text-3xl xl:text-[40px]">3</span>
                            ...
                            <div className="mt-10">
                                ...
                                <div className="flex items-center gap-4">
                                    <Link to="/" className="size-10 flex items-center justify-center rounded-full border border-[#DFE4EA] hover:border-primary hover:bg-primary hover:text-white dark:border-strokedark dark:hover:border-primary">
                                        <svg className="fill-current" width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <Link to="/" className="size-10 flex items-center justify-center rounded-full border border-[#DFE4EA] hover:border-primary hover:bg-primary hover:text-white dark:border-strokedark dark:hover:border-primary">
                                        <svg className="fill-current" width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_1878_14093)">
                                                <path d="M14.525 3.825L15.475 2.625C15.75 2.3 15.825 2.05 15.85 1.925C15.1 2.375 14.4 2.525 13.95 2.525H13.775L13.675 2.425C13.075 1.9 12.325 1.625 11.525 1.625C9.775 1.625 8.4 3.075 8.4 4.75C8.4 4.85 8.4 5 8.425 5.1L8.5 5.6L7.975 5.575C4.775 5.475 2.15 2.725 1.725 2.25C1.025 3.5 1.425 4.7 1.85 5.45L2.7 6.85L1.35 6.1C1.375 7.15 1.775 7.975 2.55 8.575L3.225 9.075L2.55 9.35C2.975 10.625 3.925 11.15 4.625 11.35L5.55 11.6L4.675 12.2C3.275 13.2 1.525 13.125 0.75 13.05C2.325 14.15 4.2 14.4 5.5 14.4C6.475 14.4 7.2 14.3 7.375 14.225C14.375 12.575 14.7 6.325 14.7 5.075V4.9L14.85 4.8C15.7 4 16.05 3.575 16.25 3.325C16.175 3.35 16.075 3.4 15.975 3.425L14.525 3.825Z" fill=""></path>
                                            </g>
                                            <defs>
