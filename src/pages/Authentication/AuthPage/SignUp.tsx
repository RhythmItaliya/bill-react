...
const SignUp: React.FC = () => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    switch (name) {
      case 'name':
        setNameError(value.length >= 3 ? null : 'Name must be at least 3 characters long');
        break;
      case 'email':
  ...
  const validatePassword = (password: string) => {
    let errorMessage = 'Password must be:';
    let isValid = true;
  ...
  return (
    <>
      <div className='flex h-screen items-center justify-center lg:w-full dark:bg-black'>
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark w-full lg:w-auto">
          <div className="flex flex-wrap items-center justify-center">
            <div className="w-full lg:w-1/2">
              <div className="py-4 px-6 sm:px-26 text-center">
                <Link className="mb-5.5 inline-block" to="/">
                  <img className="hidden dark:block" src={Logo} alt="Logo" />
                  <img className="dark:hidden" src={LogoDark} alt="Logo" />
                </Link>

                <p className="2xl:px-20 hidden md:block">
            ...
            <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
              <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {error && (
                    <div className="bg-red-100 text-red-700 p-2 text-sm mt-2 mb-5 rounded">
                      {responseError}
                    </div>
                  )}
