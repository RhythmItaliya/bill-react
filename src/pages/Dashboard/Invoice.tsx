          ...
          <div>
            ...
            <div className="flex flex-wrap justify-between gap-5">
              <div>
                ...
                <a className="block" href="/invoice">
                  <span className="font-medium text-black dark:text-white">Email: </span>contact@example.com
                </a>
                <span className="mt-1.5 block">
                  <span className="font-medium text-black dark:text-white">Address: </span>2972 Westheimer Rd. Santa Ana.
                </span>
              </div>
              <div>
                ...
                <span className="mt-1.5 block">
                  <span className="font-medium text-black dark:text-white">Address: </span>New York, USA 2707 Davis Anenue
                </span>
              </div>
            </div>
            <div className="my-7.5 grid grid-cols-1 border border-stroke dark:border-strokedark xsm:grid-cols-2 sm:grid-cols-4">
              <div className="border-b border-r border-stroke px-5 py-4 last:border-r-0 dark:border-strokedark sm:border-b-0">
                <h5 className="mb-1.5 font-bold text-black dark:text-white">Invoice ID :</h5>
              ...
              <div className="border-b border-r border-stroke px-5 py-4 last:border-r-0 dark:border-strokedark xsm:border-b-0">
                <h5 className="mb-1.5 font-bold text-black dark:text-white">Due Date :</h5>
              ...
              <div className="border-r border-stroke px-5 py-4 last:border-r-0 dark:border-strokedark">
                <h5 className="mb-1.5 font-bold text-black dark:text-white">Due Amount :</h5>
              ...
              <div className="max-w-full overflow-x-auto">
                <div className="min-w-[670px]">
                  ...
                  <div className="grid grid-cols-12 border-b border-stroke py-3.5 pl-5 pr-6 dark:border-strokedark">
                    ...
                    <div className="col-span-1">
                      <p className="text-right font-medium">$1200</p>
                    </div>
                  </div>
                  <div className="grid grid-cols-12 py-3.5 pl-5 pr-6 dark:border-strokedark">
                    <div className="col-span-3"></div>
                    <div className="col-span-4"></div>
                    <div className="col-span-2"></div>
                    <div className="col-span-2 font-bold text-black dark:text-white">Sub Total</div>
                    <div className="col-span-1 text-right font-bold">$6,000</div>
                  </div>
                  <div className="grid grid-cols-12 py-3.5 pl-5 pr-6 dark:border-strokedark">
                    <div className="col-span-3"></div>
                    <div className="col-span-4"></div>
                    <div className="col-span-2"></div>
                    <div className="col-span-2 font-bold text-black dark:text-white">Tax (10%)</div>
                    <div className="col-span-1 text-right font-bold">$600</div>
                  </div>
                  <div className="grid grid-cols-12 py-3.5 pl-5 pr-6 dark:border-strokedark">
                    <div className="col-span-3"></div>
                    <div className="col-span-4"></div>
                    <div className="col-span-2"></div>
                    <div className="col-span-2 font-bold text-black dark:text-white">Total</div>
                    <div className="col-span-1 text-right font-bold">$6,600</div>
                  </div>
                </div>
              </div>
            </div>
